<template>
    <body class="bg-gradient-to-b from-primary-200 to-primary-100/50 min-h-screen">
        <nav class="flex items-center justify-between container pt-10">
            ...
            <div class="team">
                <div class="container xl:max-w-6xl mx-auto px-4 mt-20 mb-20">
                    <!-- section header -->
                    <header class="text-center mx-auto mb-12 mt-10">
                        <h2 class="text-2xl leading-normal mb-2 font-bold">
                            <span class="text-5xl font-bold text-white text-center">Our Team</span>
                        </h2>
                    ...
                    <div class="flex flex-wrap flex-row -mx-4 justify-center">
                        <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                            <div class="relative overflow-hidden wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                                <!-- team block -->
                                ...
                                <div class="pt-6 text-center">
                                    <p class="text-lg text-white leading-normal font-bold mb-1">Muh Addeta Rukmadi</p>
                                    <p class="text-white leading-relaxed font-light">Back-End</p>
                                    <!-- social icon -->
                                    <div class="mt-2 mb-5 space-x-2">
                                        <a class="hover:text-white" aria-label="Twitter link" href="#">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem" height="1rem" viewBox="0 0 512 512">
                                                <path fill="white" d="M496,109.5a201.8,201.8,0,0,1-56.55,15.3,97.51,97.51,0,0,0,43.33-53.6,197.74,197.74,0,0,1-62.56,23.5A99.14,99.14,0,0,0,348.31,64c-54.42,0-98.46,43.4-98.46,96.9a93.21,93.21,0,0,0,2.54,22.1,280.7,280.7,0,0,1-203-101.3A95.69,95.69,0,0,0,36,130.4C36,164,53.53,193.7,80,211.1A97.5,97.5,0,0,1,35.22,199v1.2c0,47,34,86.1,79,95a100.76,100.76,0,0,1-25.94,3.4,94.38,94.38,0,0,1-18.51-1.8c12.51,38.5,48.92,66.5,92.05,67.3A199.59,199.59,0,0,1,39.5,405.6,203,203,0,0,1,16,404.2,278.68,278.68,0,0,0,166.74,448c181.36,0,280.44-147.7,280.44-275.8,0-4.2-.11-8.4-.31-12.5A198.48,198.48,0,0,0,496,109.5Z"></path>
                                            </svg>
                                        </a>
                                        <a class="hover:text-white" aria-label="Facebook link" href="#">
                                            <!-- <i class="fab fa-facebook text-facebook"></i> -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem" height="1rem" viewBox="0 0 512 512">
                                                <path fill="white" d="M455.27,32H56.73A24.74,24.74,0,0,0,32,56.73V455.27A24.74,24.74,0,0,0,56.73,480H256V304H202.45V240H256V189c0-57.86,40.13-89.36,91.82-89.36,24.73,0,51.33,1.86,57.51,2.68v60.43H364.15c-28.12,0-33.48,13.3-33.48,32.9V240h67l-8.75,64H330.67V480h124.6A24.74,24.74,0,0,0,480,455.27V56.73A24.74,24.74,0,0,0,455.27,32Z"></path>
                                            </svg>
                                        </a>
                                        <a class="hover:text-white" aria-label="Instagram link" href="#">
                                            <!-- <i class="fab fa-instagram text-instagram"></i> -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem" height="1rem" viewBox="0 0 512 512">
                                                <path fill="white" d="M349.33,69.33a93.62,93.62,0,0,1,93.34,93.34V349.33a93.62,93.62,0,0,1-93.34,93.34H162.67a93.62,93.62,0,0,1-93.34-93.34V162.67a93.62,93.62,0,0,1,93.34-93.34H349.33m0-37.33H162.67C90.8,32,32,90.8,32,162.67V349.33C32,421.2,90.8,480,162.67,480H349.33C421.2,480,480,421.2,480,349.33V162.67C480,90.8,421.2,32,349.33,32Z"></path>
                                                <path fill="white" d="M377.33,162.67a28,28,0,1,1,28-28A27.94,27.94,0,0,1,377.33,162.67Z"></path>
                                                <path fill="white" d="M256,181.33A74.67,74.67,0,1,1,181.33,256,74.75,74.75,0,0,1,256,181.33M256,144A112,112,0,1,0,368,256,112,112,0,0,0,256,144Z"></path>
                                            </svg>
                                        </a>
                                        <a class="hover:text-white" aria-label="Linkedin link" href="#">
                        ...
                        <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                            ...
                            <div class="relative overflow-hidden mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp;">
                                ...
                                <div class="pt-6 text-center">
                                    <p class="text-lg text-white leading-normal font-bold mb-1">Hadriana Nurul Pertiwi</p>
                                    <p class="text-white leading-relaxed font-light">Front-End</p>
                                    <!-- social icon -->
                                    <div class="mt-2 mb-5 space-x-2">
                                        <a class="hover:text-white" aria-label="Twitter link" href="https://twitter.com/DDDABLUE143">
                                            <!-- <i class="fab fa-twitter text-twitter"></i> -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem" height="1rem" viewBox="0 0 512 512">
                                                <path fill="white" d="M496,109.5a201.8,201.8,0,0,1-56.55,15.3,97.51,97.51,0,0,0,43.33-53.6,197.74,197.74,0,0,1-62.56,23.5A99.14,99.14,0,0,0,348.31,64c-54.42,0-98.46,43.4-98.46,96.9a93.21,93.21,0,0,0,2.54,22.1,280.7,280.7,0,0,1-203-101.3A95.69,95.69,0,0,0,36,130.4C36,164,53.53,193.7,80,211.1A97.5,97.5,0,0,1,35.22,199v1.2c0,47,34,86.1,79,95a100.76,100.76,0,0,1-25.94,3.4,94.38,94.38,0,0,1-18.51-1.8c12.51,38.5,48.92,66.5,92.05,67.3A199.59,199.59,0,0,1,39.5,405.6,203,203,0,0,1,16,404.2,278.68,278.68,0,0,0,166.74,448c181.36,0,280.44-147.7,280.44-275.8,0-4.2-.11-8.4-.31-12.5A198.48,198.48,0,0,0,496,109.5Z"></path>
                                            </svg>
                                        ...
                                        <a class="hover:text-white" aria-label="Instagram link" href="https://www.instagram.com/tiwitiwiiii__/">
                                            <!-- <i class="fab fa-instagram text-instagram"></i> -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem" height="1rem" viewBox="0 0 512 512">
                                                <path fill="white" d="M349.33,69.33a93.62,93.62,0,0,1,93.34,93.34V349.33a93.62,93.62,0,0,1-93.34,93.34H162.67a93.62,93.62,0,0,1-93.34-93.34V162.67a93.62,93.62,0,0,1,93.34-93.34H349.33m0-37.33H162.67C90.8,32,32,90.8,32,162.67V349.33C32,421.2,90.8,480,162.67,480H349.33C421.2,480,480,421.2,480,349.33V162.67C480,90.8,421.2,32,349.33,32Z"></path>
                                                <path fill="white" d="M377.33,162.67a28,28,0,1,1,28-28A27.94,27.94,0,0,1,377.33,162.67Z"></path>
                        ...
                        <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                            ...
                            <div class="relative overflow-hidden mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                                ...
                                <div class="pt-6 text-center">
                                    <p class="text-lg text-white leading-normal font-bold mb-1">A. Muh. Dzaky Siraj</p>
                                    <p class="text-white leading-relaxed font-light">Front-End</p>
                                    <!-- social icon -->
                                    <div class="mt-2 mb-5 space-x-2">
                                        <a class="hover:text-white" aria-label="Twitter link" href="#">
                                        ...
                                        <a class="hover:text-white" aria-label="Instagram link" href="https://www.instagram.com/dzky17/">
                                            <!-- <i class="fab fa-instagram text-instagram"></i> -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="1rem" height="1rem" viewBox="0 0 512 512">
                                                <path fill="white" d="M349.33,69.33a93.62,93.62,0,0,1,93.34,93.34V349.33a93.62,93.62,0,0,1-93.34,93.34H162.67a93.62,93.62,0,0,1-93.34-93.34V162.67a93.62,93.62,0,0,1,93.34-93.34H349.33m0-37.33H162.67C90.8,32,32,90.8,32,162.67V349.33C32,421.2,90.8,480,162.67,480H349.33C421.2,480,480,421.2,480,349.33V162.67C480,90.8,421.2,32,349.33,32Z"></path>
                                                <path fill="white" d="M377.33,162.67a28,28,0,1,1,28-28A27.94,27.94,0,0,1,377.33,162.67Z"></path>
                        ...
                        <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                            ...
                            <div class="relative overflow-hidden mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeInUp;">
                                ...
                                <div class="pt-6 text-center">
                                    <p class="text-lg text-white leading-normal font-bold mb-1">Adnan Fauzan Ramdhani</p>
                                    <p class="text-white leading-relaxed font-light">Back-End</p>
                                    <!-- social icon -->
                                    <div class="mt-2 mb-5 space-x-2">
                                        <a class="hover:text-white" aria-label="Twitter link" href="#">
